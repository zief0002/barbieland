...
3. What type of variable is `duration` (categorical or quantitative)? How can you tell?

4. What type of variable is `genre` (categorical or quantitative)? How can you tell?
